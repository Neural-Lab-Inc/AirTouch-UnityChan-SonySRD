...
namespace SRD.Core
{
    ...
    {
        static SrdXrDeviceInfo current_device;
        ...
        {
            XRRuntimeAPI.SetDebugLogCallback(RuntimeDebugLogCallback);
        }
        ...
        {
            SrdXrHeadPosef xrHeadPose;
            var result = XRRuntimeAPI.GetCachedHeadPose(out xrHeadPose);
                                                      ...
                                                      out Matrix4x4 leftProjectionMatrix, out Matrix4x4 rightProjectionMatrix)
        {
            ...
            var result = XRRuntimeAPI.GetProjectionMatrix(nearClip, farClip, out projMat);
        ...
        public static SrdXrResult SelectDevice()
        {
            SrdXrResult result = SrdXrResult.SUCCESS;
            UInt32 deviceCount = 0;
            result = XRRuntimeAPI.GetRealDeviceNum(ref deviceCount);
            ...
            else
            {
                ...
                if ((device_index < 0) || (deviceCount <= device_index))
                {
                    return SrdXrResult.ERROR_DEVICE_NOT_FOUND;
                }
        ...
        public static bool GetCurrentDevice(out SrdXrDeviceInfo device)
        {
        ...
        public static bool GetSRDScreenRect(out SRDSettings.ScreenRect screenRect)
        {
            ...
            if (!GetCurrentDevice(out device))
            {
        ...
        public static void SetColorSpaceSettings(ColorSpace colorSpace, GraphicsDeviceType graphicsAPI, RenderPipelineType renderPipeline)
        {
            ...
            if ((colorSpace == ColorSpace.Linear) && (graphicsAPI == GraphicsDeviceType.Direct3D11))
            {
        ...
        private struct XRRuntimeAPI
        {
            ...
            public static extern SrdXrResult GetRealDeviceNum([In, Out] ref UInt32 num);
            ...
            public static extern void SetDebugLogCallback(DebugLogDelegate debug_log_delegate);
            ...
            public static extern Int64 ShowComboBoxDialog(IntPtr hWnd, [In] string[] item_list, Int32 size);
