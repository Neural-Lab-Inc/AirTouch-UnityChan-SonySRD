    ...
    internal static partial class SRDHelper
    {
        public static class SRDMessages
        {
            ...
            private static Dictionary<SRDMessageType, string> SRDMessagesDictEn = new Dictionary<SRDMessageType, string>()
            {
                ...
                {SRDMessageType.DLLNotFoundError, "SR Display SDK is not found. SR Display SDK may be not installed correctly. Try to re-install with SR Display installer."},
                {SRDMessageType.DisplayInterruptionError, "Display connection has been interrupted. The Display cable may be disconnected."},
                {SRDMessageType.DeviceInterruptionError, "USB connection has been interrupted. The USB cable may be disconnected or SR Display's power may be turned off."},
                ...
                {SRDMessageType.FullscreenGameViewError, "No SR Display is connected. Please make sure that SR Display is connected with your PC correctly."},
